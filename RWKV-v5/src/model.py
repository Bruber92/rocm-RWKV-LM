...
class RWKV(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        if args.weight_decay > 0:
            ...
            return ZeroOneAdam(optim_groups, self.args.deepspeed_engine, lr=self.args.lr_init, betas=self.args.betas, eps=self.args.adam_eps, bias_correction=True, weight_decay=0, amsgrad=False, cuda_aware=False)
        else:
            if self.deepspeed_offload:
